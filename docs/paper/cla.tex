...
maximum, exploiting the same piecewise-linear weight structure. A per-segment closed
form exists, since on an affine weight segment the Sharpe ratio is an affine function
over the square root of a quadratic; the bounded one-dimensional search is used for
simplicity and is exact to tolerance.

...
% they do not rot as the code is refactored. Currently pinned to the latest mainline
% commit that matches the manuscript (the Cholesky free-block solve, the conditioning
% guard, and the constrained/non-negative LASSO); replace with the tagged/archived
% release (the Zenodo-archived commit) at submission time.
\newcommand{\srcref}{ce875aa480d314f1f309cb40b9bd3ebc23d321a1}

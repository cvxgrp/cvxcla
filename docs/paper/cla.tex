...
open, tested, and benchmarked implementation. Concretely:
...
and is identical on every platform. This is the precise guarantee: while the
free-asset block stays full rank the trace completes and every turning point is
optimal; when it does not, the algorithm declines rather than mislead. A

...
\begin{aug}
\author[A]{\fnms{Trevor John}~\snm{Hastie}\thanksref{t1}\ead[label=e1]{hastie@stanford.edu}}
\author[B]{\fnms{Thomas}~\snm{Schmelzer}\ead[label=e2]{thomas@jqr.ae}}
...
re-entering the free set as $\lambda$ decreases. It is the oldest instance by four
decades (Section~\ref{sec:history}) and, through Theorem~\ref{thm:identity}, the
portfolio face of the LASSO.

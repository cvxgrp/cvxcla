...
= s_\Aset\trans(\alpha_\Aset - \lambda\,\beta_{\mathrm{slope},\Aset})$, affine in
$\lambda$ with the stated slope; continuity across breakpoints follows from continuity
...
= \big\|(Z\trans H_{\F\F}Z)^{-1/2}Z\trans s_\Aset\big\|_2^2 \ge 0$, with equality only
when $Z\trans s_\Aset = 0$, i.e.\ when $s_\Aset$ lies in the span of the active normals.

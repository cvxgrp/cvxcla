...
piecewise-linear curve, breakpoints in bijection. The identity is exact, and, beyond the
...
optimizer and a sparse regression, are under one substitution the same curve,
breakpoint for breakpoint, and the identity persists under arbitrary linear

...
\author[B]{\fnms{Thomas}~\snm{Schmelzer}\ead[label=e2]{thomas.s@yukkalab.com}}
...
\address[B]{Thomas Schmelzer, \textit{affiliation to be completed}%
\printead[presep={\ }]{e2}.}
\end{aug}
...
\quad s_\Aset = \operatorname{sign}\!\big(\beta_\Aset\big),
\]
